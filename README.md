...
Obviously the LJSpeech dataset is also necessary, done in exactly the same way as for TT2.\
Any other imports must then be resolved, but these are the main three.\
\
